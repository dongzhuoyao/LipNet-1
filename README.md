...
You can change this by adding ``vtype = "face"`` and ``face_predictor_path`` (which can be found in ``common/predictors/shape_predictor_68_face_landmarks.dat``) in the instantiation of ``Generator`` inside the ``train.py``
